...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('assets/assets_cashier/style.css') }}">
  <link rel="shortcut icon" href="{{ asset('assets/assets_cashier/favicon.ico') }}" type="image/x-icon">
  <script src="https://unpkg.com/idb/build/iife/index-min.js"></script>
  <script src="https://cdn.jsdelivr.net/gh/alpinejs/alpine@v2.8.2/dist/alpine.min.js"></script>
  <script src="{{ asset('assets/assets_cashier/script.js') }}"></script>
</head>
    ...
    <div x-show="isShowModalReceipt"
      ...
      <div x-show="isShowModalReceipt" class="w-96 rounded-3xl bg-white shadow-xl overflow-hidden z-10"
        ...
        <div id="receipt-content" class="text-left w-full text-sm p-6 overflow-auto">
          <div class="text-center">
            <img src="{{ asset('assets/assets_cashier/img/receipt-logo.png') }}" alt="Tailwind POS">
